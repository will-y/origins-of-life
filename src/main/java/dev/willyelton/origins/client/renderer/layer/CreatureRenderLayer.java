...
public class CreatureRenderLayer extends RenderLayer<CreatureRenderState, CreatureModel> {
    private final CreatureModel creatureModel;

    public CreatureRenderLayer(RenderLayerParent<CreatureRenderState, CreatureModel> renderer, EntityModelSet entityModelSet) {
        super(renderer);
    ...
    @Override
    public void submit(PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords, CreatureRenderState state, float yRot, float xRot) {
